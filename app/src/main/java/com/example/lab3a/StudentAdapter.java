...
public class StudentAdapter extends BaseAdapter {
    ...
    private ArrayList<com.example.listviewdemo.Student> mDataSource;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.listviewdemo.Student student = (com.example.listviewdemo.Student) getItem(position);
